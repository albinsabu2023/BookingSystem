...
<body>
	...
	<div class="content" id="content">
			...
			<div id="roomList">
				...
				<div class="room-card" data-room-id="<%=room.getId()%>"
					...
					<div class="room-footer">
						<button class="book-btn" id="book-btn" style="<%=room.isActive()? "display:hidden" :"display:block" %>"
		...
		<div id="bookingModal" class="booking-modal">
			...
			<div class="form-item">
				<label>Max Capacity:</label> <input type="text" id="bookMaxCapacity"
					readonly> <label>Required Capacity:</label> <input
					type="number" id="bookCapacity" min="1" name="requiredCapacity">
			</div>
